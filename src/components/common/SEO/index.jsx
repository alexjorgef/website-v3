...
export const SEO = ({
  ...
  return (
    <Helmet>
      ...
      <meta
        property="og:title"
        content={title ? `alexjorgef | ${title}` : defaultTitle}
      />
      <meta
      ...
      <title>{title ? `Alex Ferreira | ${title}` : defaultTitle}</title>
      {type === 'NewsArticle' && (
      ...
      {type === 'NewsArticle' && (
        <meta name="author" content="Alexandre Ferreira" data-react-helmet="true" />
      )}
      {type === 'NewsArticle' && (
        <meta
